            ...
            <div class="box">
                <div class="box-header">
                    <div class="row" style="margin: 0">
                        <div class="pull-left">
                            <h3 class="box-title">Xem trước sản phẩm</h3>
                        </div>
                                ...
                                <div class="col-md-5 pt-5">
                                    ...
                                    <h3>
                                        @if ($details->sale_price > 0)
                                            ...
                                            <small><s>{{ number_format($details->price) }}</s></small>
                                        @else
                                            ${{ $details->price }}đ
                                        @endif
                                    </h3>
                                    <div class="banner-even py-3">
                                        <img src="{{ asset('assets-client') }}/img/banner/Nike-Banner.jpg" alt=""
                                            width="60%">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <form action="" method="" class="form-inline" role="form"
                                                            ...
                                                            <label class="form-check-label"
                                                                ...
                                                                <div class="pr-2">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="size" id="" value="0" checked
                                                                        onclick="showSize(this)">
                                                                    M
                                                                </div>
                                                                <div class="pr-2">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="size" id="" value="1"
                                                                        onclick="showSize(this)"> L
                                                                </div>
                                                                <div class="pr-2">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="size" id="" value="2"
                                                                        onclick="showSize(this)"> Xl
                                                                </div>

                                                                <div class="pr-2"><input class="form-check-input"
                                                                        type="radio" name="size" id=""
                                                                        value="3" onclick="showSize(this)"> 2XL
                                                                </div>
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <button type="submit" class="btn btn-success mr-1 ml-3">Thêm vào giỏ
                                                    hàng</button>
                                            </div>
