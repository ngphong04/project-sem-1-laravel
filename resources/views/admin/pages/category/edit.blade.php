                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name"
                                    value="{{ old('name') ? old('name') : $category->name }}" class="form-control"
                                    id="category_name" onkeyup="ChangeToSlug()">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" value="{{ old('category_id') }}" name="parent_id"
                                    id="">
                                ...
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="status" id=""
                                            value="1" {{ $category->status ? 'checked' : '' }}> Hiện
                                        <input class="form-check-input" type="radio" name="status" id=""
                                            value="0" {{ !$category->status ? 'checked' : '' }}> Ẩn
                                    </label>
                                </div>
                            </div>
